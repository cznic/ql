...
// at 2013-11-03 18:47:19.458784788 +0100 CET
//
...
InsertIntoStmt:
	...
	{
		$$ = []InsertIntoStmt{"INSERT", "INTO", $3, $4, $5} //TODO 61
	}
...
Predicate1:
	...
	{
		$$ = []Predicate1{$1, $2, "IS", $4, "NULL"} //TODO 84
	}
...
Predicate12:
	_IN '(' ExpressionList ')'
	{
		$$ = []Predicate12{"IN", "(", $3, ")"} //TODO 87
	}
|	_BETWEEN PrimaryFactor _AND PrimaryFactor
	{
		$$ = []Predicate12{"BETWEEN", $2, "AND", $4} //TODO 88
	}
...
PrimaryFactor:
	...
	{
		$$ = []PrimaryFactor{$1, $2} //TODO 96
	}

PrimaryFactor1:
	/* EMPTY */
	{
		$$ = []PrimaryFactor1(nil) //TODO 97
	}
|	PrimaryFactor1 PrimaryFactor11 PrimaryTerm
	{
		$$ = append($1.([]PrimaryFactor1), $2, $3) //TODO 98
	}
...
PrimaryTerm:
	...
	{
		$$ = []PrimaryTerm{$1, $2} //TODO 103
	}

PrimaryTerm1:
	/* EMPTY */
	{
		$$ = []PrimaryTerm1(nil) //TODO 104
	}
|	PrimaryTerm1 PrimaryTerm11 UnaryExpr
	{
		$$ = append($1.([]PrimaryTerm1), $2, $3) //TODO 105
	}
...
|	'.' _IDENTIFIER
	{
		$$ = []QualifiedIdent1{".", $2} //TODO 115
	}

RecordSet:
	RecordSet1 RecordSet2
	{
		$$ = []RecordSet{$1, $2} //TODO 116
	}
...
|	_AS _IDENTIFIER
	{
		$$ = []RecordSet2{"AS", $2} //TODO 122
	}

RecordSetList:
	RecordSet RecordSetList1 RecordSetList2
	{
		$$ = []RecordSetList{$1, $2, $3} //TODO 123
	}

RecordSetList1:
	/* EMPTY */
	{
		$$ = []RecordSetList1(nil) //TODO 124
	}
|	RecordSetList1 ',' RecordSet
	{
		$$ = append($1.([]RecordSetList1), ",", $3) //TODO 125
	}
...
SelectStmt:
	_SELECT SelectStmt1 SelectStmt2 _FROM RecordSetList SelectStmt3 SelectStmt4
	{
		$$ = []SelectStmt{"SELECT", $2, $3, "FROM", $5, $6, $7} //TODO 129
	}
...
StatementList:
	...
	{
		$$ = []StatementList{$1, $2} //TODO 156
	}

StatementList1:
	/* EMPTY */
	{
		$$ = []StatementList1(nil) //TODO 157
	}
|	StatementList1 ';' Statement
	{
		$$ = append($1.([]StatementList1), ";", $3) //TODO 158
	}
...
|	Term1 _ANDAND Factor
	{
		$$ = append($1.([]Term1), $2, $3) //TODO 162
	}

TruncateTableStmt:
	_TRUNCATE _TABLE TableName
	{
		$$ = []TruncateTableStmt{"TRUNCATE", "TABLE", $3} //TODO 163
	}
...
UpdateStmt:
	...
	{
		$$ = []UpdateStmt{"UPDATE", $2, $3, $4} //TODO 190
	}
...
Values:
	...
	{
		$$ = []Values{"VALUES", "(", $3, ")", $5, $6} //TODO 193
	}

Values1:
	/* EMPTY */
	{
		$$ = []Values1(nil) //TODO 194
	}
|	Values1 ',' '(' ExpressionList ')'
	{
		$$ = append($1.([]Values1), ",", "(", $4, ")") //TODO 195
	}
