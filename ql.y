...
// at 2013-11-21 12:03:43.33146062 +0100 CET
//
...
UpdateStmt:
	...
	{
		$$ = []UpdateStmt{"UPDATE", $2, $3, $4} //TODO 194
	}
...
Values:
	...
	{
		$$ = []Values{"VALUES", "(", $3, ")", $5, $6} //TODO 197
	}

Values1:
	/* EMPTY */
	{
		$$ = []Values1(nil) //TODO 198
	}
|	Values1 ',' '(' ExpressionList ')'
	{
		$$ = append($1.([]Values1), ",", "(", $4, ")") //TODO 199
	}
