...
// at 2014-06-05 14:03:44.841576362 +0200 CEST
//
...
UpdateStmt:
	...
	{
		$$ = []UpdateStmt{"UPDATE", $2, $3, $4, $5} //TODO 221
	}
...
Values:
	...
	{
		$$ = []Values{"VALUES", "(", $3, ")", $5, $6} //TODO 226
	}

Values1:
	/* EMPTY */
	{
		$$ = []Values1(nil) //TODO 227
	}
|	Values1 ',' '(' ExpressionList ')'
	{
		$$ = append($1.([]Values1), ",", "(", $4, ")") //TODO 228
	}
