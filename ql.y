...
// at 2013-11-06 10:57:53.814890719 +0100 CET
//
...
UpdateStmt:
	...
	{
		$$ = []UpdateStmt{"UPDATE", $2, $3, $4} //TODO 193
	}
...
Values:
	...
	{
		$$ = []Values{"VALUES", "(", $3, ")", $5, $6} //TODO 196
	}

Values1:
	/* EMPTY */
	{
		$$ = []Values1(nil) //TODO 197
	}
|	Values1 ',' '(' ExpressionList ')'
	{
		$$ = append($1.([]Values1), ",", "(", $4, ")") //TODO 198
	}
