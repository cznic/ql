...
// at 2013-11-26 09:54:14.662339685 +0100 CET
//
...
UpdateStmt:
	...
	{
		$$ = []UpdateStmt{"UPDATE", $2, $3, $4} //TODO 196
	}
...
Values:
	...
	{
		$$ = []Values{"VALUES", "(", $3, ")", $5, $6} //TODO 199
	}

Values1:
	/* EMPTY */
	{
		$$ = []Values1(nil) //TODO 200
	}
|	Values1 ',' '(' ExpressionList ')'
	{
		$$ = append($1.([]Values1), ",", "(", $4, ")") //TODO 201
	}
