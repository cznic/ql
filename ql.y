...
// at 2015-04-17 14:03:53.379700075 +0200 CEST
//
...
Predicate1:
	...
	{
		$$ = []Predicate1{$1, $2} //TODO 111
	}
|	_IS Predicate13 _NULL
	{
		$$ = []Predicate1{"IS", $2, "NULL"} //TODO 112
	}
...
Predicate12:
	_IN '(' ExpressionList ')'
	{
		$$ = []Predicate12{"IN", "(", $3, ")"} //TODO 115
	}
|	_IN '(' SelectStmt ')'
	{
		$$ = []Predicate12{"IN", "(", $3, ")"} //TODO 116
	}
|	_BETWEEN PrimaryFactor _AND PrimaryFactor
	{
		$$ = []Predicate12{"BETWEEN", $2, "AND", $4} //TODO 117
	}
...
|	PrimaryExpression Index
	{
		$$ = []PrimaryExpression{$1, $2} //TODO 122
	}
|	PrimaryExpression Slice
	{
		$$ = []PrimaryExpression{$1, $2} //TODO 123
	}
|	PrimaryExpression Call
	{
		$$ = []PrimaryExpression{$1, $2} //TODO 124
	}

PrimaryFactor:
	PrimaryTerm PrimaryFactor1
	{
		$$ = []PrimaryFactor{$1, $2} //TODO 125
	}

PrimaryFactor1:
	/* EMPTY */
	{
		$$ = []PrimaryFactor1(nil) //TODO 126
	}
|	PrimaryFactor1 PrimaryFactor11 PrimaryTerm
	{
		$$ = append($1.([]PrimaryFactor1), $2, $3) //TODO 127
	}
...
PrimaryTerm:
	...
	{
		$$ = []PrimaryTerm{$1, $2} //TODO 132
	}

PrimaryTerm1:
	/* EMPTY */
	{
		$$ = []PrimaryTerm1(nil) //TODO 133
	}
|	PrimaryTerm1 PrimaryTerm11 UnaryExpr
	{
		$$ = append($1.([]PrimaryTerm1), $2, $3) //TODO 134
	}
...
|	'.' _IDENTIFIER
	{
		$$ = []QualifiedIdent1{".", $2} //TODO 144
	}

RecordSet:
	RecordSet1 RecordSet2
	{
		$$ = []RecordSet{$1, $2} //TODO 145
	}
...
|	_AS _IDENTIFIER
	{
		$$ = []RecordSet2{"AS", $2} //TODO 151
	}

RecordSetList:
	RecordSet RecordSetList1 RecordSetList2
	{
		$$ = []RecordSetList{$1, $2, $3} //TODO 152
	}

RecordSetList1:
	/* EMPTY */
	{
		$$ = []RecordSetList1(nil) //TODO 153
	}
|	RecordSetList1 ',' RecordSet
	{
		$$ = append($1.([]RecordSetList1), ",", $3) //TODO 154
	}
...
SelectStmt:
	...
	{
		$$ = []SelectStmt{"SELECT", $2, $3, "FROM", $5, $6, $7, $8, $9, $10} //TODO 158
	}
...
StatementList:
	...
	{
		$$ = []StatementList{$1, $2} //TODO 193
	}

StatementList1:
	/* EMPTY */
	{
		$$ = []StatementList1(nil) //TODO 194
	}
|	StatementList1 ';' Statement
	{
		$$ = append($1.([]StatementList1), ";", $3) //TODO 195
	}
...
TruncateTableStmt:
	...
	{
		$$ = []TruncateTableStmt{"TRUNCATE", "TABLE", $3} //TODO 202
	}
...
UpdateStmt:
	...
	{
		$$ = []UpdateStmt{"UPDATE", $2, $3, $4, $5} //TODO 234
	}
...
Values:
	...
	{
		$$ = []Values{"VALUES", "(", $3, ")", $5, $6} //TODO 239
	}

Values1:
	/* EMPTY */
	{
		$$ = []Values1(nil) //TODO 240
	}
|	Values1 ',' '(' ExpressionList ')'
	{
		$$ = append($1.([]Values1), ",", "(", $4, ")") //TODO 241
	}
