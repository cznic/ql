...
var (
	yyXLAT = map[int]int{
		...
		57497: 66,  // Type (47x)
		42:    67,  // '*' (46x)
		57442: 68,  // Conversion (46x)
		57469: 69,  // Literal (46x)
		57470: 70,  // Operand (46x)
		57473: 71,  // PrimaryExpression (46x)
		57476: 72,  // QualifiedIdent (46x)
		57347: 73,  // and (45x)
		33:    74,  // '!' (44x)
		37:    75,  // '%' (43x)
		38:    76,  // '&' (43x)
		...
		57397: 79,  // lsh (43x)
		57407: 80,  // rsh (43x)
		57498: 81,  // UnaryExpr (42x)
		57475: 82,  // PrimaryTerm (35x)
		57474: 83,  // PrimaryFactor (31x)
		91:    84,  // '[' (30x)
		57458: 85,  // Factor (20x)
		57459: 86,  // Factor1 (20x)
		57495: 87,  // Term (19x)
		57454: 88,  // Expression (18x)
		57437: 89,  // ColumnName (10x)
		57494: 90,  // TableName (9x)
		57409: 91,  // selectKwd (7x)
		57455: 92,  // ExpressionList (6x)
		57434: 93,  // Call (5x)
		57464: 94,  // Index (5x)
		57491: 95,  // Slice (5x)
		57436: 96,  // ColumnDef (4x)
		57368: 97,  // drop (4x)
		57371: 98,  // exists (4x)
		57381: 99,  // ifKwd (4x)
		57384: 100, // index (4x)
		57483: 101, // SelectStmt (4x)
		57413: 102, // tableKwd (4x)
		57425: 103, // values (4x)
		57501: 104, // WhereClause (4x)
		61:    105, // '=' (2x)
		57345: 106, // add (2x)
		57346: 107, // alter (2x)
		57428: 108, // AlterTableStmt (2x)
		57429: 109, // Assignment (2x)
		57352: 110, // begin (2x)
		57433: 111, // BeginTransactionStmt (2x)
		57358: 112, // by (2x)
		57438: 113, // ColumnNameList (2x)
		57361: 114, // commit (2x)
		57441: 115, // CommitStmt (2x)
		57364: 116, // create (2x)
		57444: 117, // CreateIndexStmt (2x)
		57446: 118, // CreateTableStmt (2x)
		57447: 119, // CreateTableStmt1 (2x)
		57448: 120, // CreateTableStmt2 (2x)
		57449: 121, // DeleteFromStmt (2x)
		57365: 122, // deleteKwd (2x)
		57451: 123, // DropIndexStmt (2x)
		57452: 124, // DropTableStmt (2x)
		57453: 125, // EmptyStmt (2x)
		57460: 126, // Field (2x)
		57463: 127, // GroupByClause (2x)
		57385: 128, // insert (2x)
		57465: 129, // InsertIntoStmt (2x)
		57471: 130, // OrderBy (2x)
		57477: 131, // RecordSet (2x)
		57478: 132, // RecordSet1 (2x)
		57406: 133, // rollback (2x)
		57482: 134, // RollbackStmt (2x)
		57486: 135, // SelectStmtGroup (2x)
		57487: 136, // SelectStmtLimit (2x)
		57488: 137, // SelectStmtOffset (2x)
		57489: 138, // SelectStmtOrder (2x)
		57490: 139, // SelectStmtWhere (2x)
		57410: 140, // set (2x)
		57492: 141, // Statement (2x)
		57417: 142, // truncate (2x)
		57496: 143, // TruncateTableStmt (2x)
		57424: 144, // update (2x)
		57499: 145, // UpdateStmt (2x)
		46:    146, // '.' (1x)
		57430: 147, // AssignmentList (1x)
		57431: 148, // AssignmentList1 (1x)
		57432: 149, // AssignmentList2 (1x)
		57435: 150, // Call1 (1x)
		57360: 151, // column (1x)
		57439: 152, // ColumnNameList1 (1x)
		57440: 153, // ColumnNameList2 (1x)
		57443: 154, // CreateIndexIfNotExists (1x)
		57445: 155, // CreateIndexStmtUnique (1x)
		57367: 156, // distinct (1x)
		57450: 157, // DropIndexIfExists (1x)
		57456: 158, // ExpressionList1 (1x)
		57457: 159, // ExpressionList2 (1x)
		57461: 160, // Field1 (1x)
		57462: 161, // FieldList (1x)
		57466: 162, // InsertIntoStmt1 (1x)
		57467: 163, // InsertIntoStmt2 (1x)
		57468: 164, // InsertIntoStmt3 (1x)
		57391: 165, // into (1x)
		57402: 166, // on (1x)
		57472: 167, // OrderBy1 (1x)
		57502: 168, // oSet (1x)
		57479: 169, // RecordSet11 (1x)
		57480: 170, // RecordSet2 (1x)
		57481: 171, // RecordSetList (1x)
		57484: 172, // SelectStmtDistinct (1x)
		57485: 173, // SelectStmtFieldList (1x)
		57493: 174, // StatementList (1x)
		57415: 175, // transaction (1x)
		57423: 176, // unique (1x)
		57500: 177, // UpdateStmt1 (1x)
		57427: 178, // $default (0x)
		57344: 179, // error (0x)
	}
