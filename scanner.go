...
yystart1:
	...
	case c == 'G' || c == 'g':
		goto yystate158
	case c == 'H' || c >= 'J' && c <= 'M' || c == 'P' || c == 'Q' || c >= 'X' && c <= 'Z' || c == '_' || c == 'h' || c >= 'j' && c <= 'm' || c == 'p' || c == 'q' || c >= 'x' && c <= 'z':
		goto yystate163
	case c == 'I' || c == 'i':
		goto yystate164
	case c == 'N' || c == 'n':
...
yystate190:
	...
	case c == 'R' || c == 'r':
		goto yystate192
	case c >= '0' && c <= '9' || c >= 'A' && c <= 'M' || c >= 'O' && c <= 'Q' || c >= 'S' && c <= 'Z' || c == '_' || c >= 'a' && c <= 'm' || c >= 'o' && c <= 'q' || c >= 's' && c <= 'z':
		goto yystate49
	}
...
yystart278:
	switch {
	default:
		goto yystate279 // c >= '\x01' && c <= '!' || c >= '#' && c <= '[' || c >= ']' && c <= 'ÿ'
	case c == '"':
		goto yystate280
	case c == '\\':
		goto yystate281
...
yystate282:
	...
	goto yystate283 // silence unused label error
yystate283:
	c = l.next()
yystart283:
	switch {
	default:
		goto yystate284 // c >= '\x01' && c <= '_' || c >= 'a' && c <= 'ÿ'
	case c == '\x00':
		goto yystate2
	case c == '`':
		goto yystate285
