...
yystart1:
	...
	case c == 'D' || c == 'd':
		goto yystate100
	case c == 'E' || c == 'G' || c == 'H' || c >= 'J' && c <= 'M' || c == 'P' || c == 'Q' || c >= 'X' && c <= 'Z' || c == '_' || c == 'e' || c == 'g' || c == 'h' || c >= 'j' && c <= 'm' || c == 'p' || c == 'q' || c >= 'x' && c <= 'z':
		goto yystate118
	case c == 'F' || c == 'f':
		goto yystate119
	case c == 'I' || c == 'i':
...
yystart236:
	switch {
	default:
		goto yystate237 // c >= '\x01' && c <= '!' || c >= '#' && c <= '[' || c >= ']' && c <= 'ÿ'
	case c == '"':
		goto yystate238
	case c == '\\':
		goto yystate239
...
yystart241:
	switch {
	default:
		goto yystate242 // c >= '\x01' && c <= '_' || c >= 'a' && c <= 'ÿ'
	case c == '\x00':
		goto yystate2
	case c == '`':
		goto yystate243
